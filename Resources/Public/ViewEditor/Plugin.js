...
var ViewEditor = (_temp = _class = function (_PureComponent) {
    _inherits(ViewEditor, _PureComponent);

    function ViewEditor() {
        _classCallCheck(this, ViewEditor);

        return _possibleConstructorReturn(this, (ViewEditor.__proto__ || Object.getPrototypeOf(ViewEditor)).apply(this, arguments));
    }

    _createClass(ViewEditor, [{
        key: 'getView',
        value: function getView(route) {
        ...
        value: function render() {
            var route = (0, _plowJs.$get)('options.configuration.route', this.props);
            var id = (0, _plowJs.$get)('options.configuration.id', this.props);

            return _react2.default.createElement(
                'div',
                { id: id },
                _react2.default.createElement('div', { className: id + '-wrapper', dangerouslySetInnerHTML: { __html: this.getView(route) } })
            );
        }
    }]);
...
var _ViewEditor = __webpack_require__(/*! ./ViewEditor */ "./src/ViewEditor.js");

var _ViewEditor2 = _interopRequireDefault(_ViewEditor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('NeosRulez.Neos:ViewEditor', {}, function (globalRegistry) {
    ...
    editorsRegistry.set('NeosRulez/Neos/Inspector/Editors/ViewEditor', {
        component: _ViewEditor2.default
    });
});
